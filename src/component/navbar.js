...
import logo from "./logosvg1.svg"
import { Link } from "react-router-dom";

export default function Navbar() {
    return(
        <>
        <nav id="header" className="fixed w-full z-30 top-0 text-white backdrop-blur-md">
            <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
                ...
                <ul className="list-reset lg:flex justify-end flex-1 items-center">
                    <li className="mr-3">
                    <Link to={"/"}><a className="inline-block py-2 px-4 text-white font-bold no-underline" href="#">Home</a></Link>
                    </li>
                    <li className="mr-3">
